...
# I'm guessing that these cases are a result of a data input error. After browsing them
# Some of the fields don't match up: Control date, when inputted, close to incident or dispach date.. Also the times used tend to be all over the place and don't correspond to other columns. 
